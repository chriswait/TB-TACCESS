...
\iffalse
\item[\textbf{Barriers Common to Mobile Device Users and People with Disabilities:}]
...
\begin{itemize}
\item \textit{Information conveyed solely with colour} - this information could become inaccessible to users who perceive colour incorrectly.
\item \textit{Non-text objects with no text alternative} - if the user cannot perceive the information in the object (for example, images) the same information must be provided in text format.
\item \textit{Long words, long and complete sentences, jargon} - information given should be concise and suitable for dictation, or it may be misunderstood.
\item \textit{Text entry} - many users with disabilities find text entry challenging and slow.
\item \textit{Missing or inappropriate page title} - this can prevent a user using a screen reader from gaining an overview of the contents of the current page/screen.
\end{itemize}
...
\begin{figure}[htbp]\centering
    \begin{minipage}[b]{0.45\linewidth}
        \centering
                \fbox{\includegraphics[width=0.9\textwidth]{edinbus}}
      \end{minipage}
\quad   \begin{minipage}[b]{0.45\linewidth}
           \centering
                \fbox{\includegraphics[width=0.9\textwidth]{lothian}}
      \end{minipage}
...
\centering
  ...
  \centering
    \fbox{\includegraphics[width=0.8\textwidth]{fob}}
          \end{minipage}
...
\begin{figure}[htbp]
  \centering
    \begin{minipage}[b]{0.45\linewidth}
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{scotTalk}}
          \end{minipage}
...
\begin{enumerate}
\item A smartphone application capable of requesting and displaying real-time bus information from a remote location.
\item A server application capable of storing and updating bus service information and delivering it to the mobile application.
\end{enumerate}
%
...
\begin{figure}[htbp]
  \centering
    \fbox{\includegraphics[width=0.5\textwidth]{busStopNames}}
...
\begin{figure}[htbp]
  \centering
    \fbox{\includegraphics[width=0.5\textwidth]{updateArch}}
